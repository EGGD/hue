...
class CircleAndLine extends Component {
  ...
  render() {
    ...
    return (
      <svg onClick={()=>{this.props.setRightCircleAndTextData(this.state.fatherData)}} width={svgCircleWidth} height={svgCircleHeight} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 100 300" >
        <g id="text">
        ...
        <g id="line">
          ...
          {/* G */}
          <g>
            <line stroke="#fff" strokeWidth={3} opacity={svgCircleOpacity} x1="55" y1="171.4" x2="55" y2="293" strokeLinecap="round" />
          ...
          {/* B */}
          <g>
            <line stroke="#fff" strokeWidth={3} opacity={svgCircleOpacity} x1="50.2" y1="171.4" x2="50.2" y2="293" strokeLinecap="round" />
        ...
        <g id="C">
          <circle fill="none" strokeWidth={svgCircleLineWidth} opacity={svgCircleOpacity} stroke="#fff" cx="36" cy="28.1" r="15" />
        ...
        <g id="M">
          <circle fill="none" strokeWidth={svgCircleLineWidth} opacity={svgCircleOpacity} stroke="#fff" cx="36" cy="69.7" r="15" />
        ...
        <g id="Y">
          <circle fill="none" strokeWidth={svgCircleLineWidth} opacity={svgCircleOpacity} stroke="#fff" cx="36" cy="111.2" r="15" />
        ...
        <g id="K">
          <circle fill="none" strokeWidth={svgCircleLineWidth} opacity={svgCircleOpacity} stroke="#fff" cx="36" cy="152.7" r="15" />
